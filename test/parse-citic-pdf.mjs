...
const pdfPath = process.argv[2] || '/Users/logiclocmusic/Downloads/6a2f1c5d53d3467fa4c268912b0f10cb.pdf';
...
const sourceName = Parsers.resolveSourceName({ name: 'citic-statement.pdf' }, rows, format, sources);
const records = Parsers.parseCiticBank(rows, sourceName);
